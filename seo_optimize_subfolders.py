...
INDEX_OVERRIDES = {
    "soulblueprint": {
        "title": "Deep Numerology & Life Path Reading | Quantum Merlin",
        "description": "Discover your complete cosmic profile through advanced numerology. Life path, expression, soul urge, personality numbers, pinnacles, challenges, and karmic lessons all in one reading.",
        "keywords": "numerology reading, life path, expression number, soul urge, personality number, pinnacles, karmic lessons, quantum merlin",
