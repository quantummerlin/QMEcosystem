...
var DEEP_NORTH_NODE_READINGS = {
 ...
 southNode: "Libra",
 hook: "With North Node in Aries, your journey is toward independence, courage, and self-assertion. The comfort zone (South Node in Libra) was relationships, harmony, and considering others - but growth requires learning to put self first and act with warrior courage.",
 
 pastLifePatterns: `The South Node in Libra reveals deep-rooted (or early childhood) patterns of focusing entirely on others, seeking approval, and maintaining harmony at all costs. You was the diplomat, the peacemaker, the one who always considered others' needs before your own.
...
You may find yourself naturally drawn to relationships, sometimes jumping from one to another without pause. Being alone feels wrong or scary. Making decisions for yourself triggers anxiety - what if you choose wrong? What if others don't approve?
...
The old pattern is to wait for others to lead, to define yourself through partnerships, and to believe you're only valuable in relation to someone else. Independence feels selfish; assertiveness feels aggressive. The reflex is always to consider the other person first.`,
 ...
 newDirection: `The Aries North Node calls you to develop independence, courage, and healthy selfishness. This means learning to act without permission, to put yourself first without guilt, and to embrace conflict when it serves truth.
...
The journey is toward discovering what YOU want, independent of others' preferences. It's about making quick decisions without consensus, taking action without approval, and being willing to be disliked for being yourself. It's warrior training for someone who was taught to be diplomat.`,
 ...
 evolutionaryGoal: `The ultimate goal is to become a strong individual who can then create balanced partnerships from wholeness rather than need. The Aries development doesn't negate Libra gifts - it completes you.

You are learning that true harmony comes from two whole people, not from one person accommodating the other. Real partnership requires the ability to stand alone, disagree, and fight fairly. The warrior energy serves relationship by ensuring both people remain authentic.
...
The gift you bring to relationships once evolved is the Libra social grace combined with Aries authenticity. You create partnerships where both people are fully yourself, where harmony is real rather than performed, where love doesn't require self-sacrifice.`,
...
Ultimately, this placement is about learning that independence and relationship aren't opposites - you support each other. The warrior who knows how to stand alone creates the deepest partnerships because you choose you from freedom, not need.`,
 ...
 southNode: "Scorpio",
 hook: "With North Node in Taurus, your journey is toward stability, simplicity, and self-worth. The comfort zone (South Node in Scorpio) was intensity, crisis, and depending on others' resources - but growth requires building your own security and finding peace.",
 
 pastLifePatterns: `The South Node in Scorpio reveals deep-rooted patterns of intensity, transformation through crisis, and deep entanglement with others' resources and energies. You was the transformer, the detective, the one who delved into darkness and emerged changed.
...
But the shadow of this pattern is addiction to intensity, creating or attracting crisis, and inability to find peace in simplicity. Too many years of emotional extremes created belief that calm means something's wrong and that transformation requires trauma.`,
 ...
 oldComfortZone: `The Scorpio South Node comfort zone manifests as attraction to drama, crisis, and intensity. You may unconsciously create or attract situations that require survival mode, crisis management, or deep transformation. Calm feels boring or wrong.
...
The old pattern is to believe that growth requires crisis, that depth requires darkness, and that peace means stagnation. Simple pleasures feel shallow; stability feels like a trap. The familiar territory is transformation through trauma rather than gentle cultivation.`,
 ...
 newDirection: `The Taurus North Node calls you to develop stability, simplicity, and self-sufficiency. This means learning to build your own resources, find peace in ordinary moments, and value yourself independently of drama or others' validation.
...
The journey is toward discovering that peace is productive, that slow growth is real growth, and that you can be powerful without being intense. It's learning to accumulate rather than transform, to build rather than burn down and rebuild.`,
 ...
 evolutionaryGoal: `The ultimate goal is to become someone who is secure within yourself, who owns your own resources, and who can appreciate life's simple pleasures. The Taurus development doesn't negate Scorpio depth - it grounds it.

You are learning that transformation doesn't always require crisis. Growth can be gentle, steady, and sustainable. Peace isn't stagnation - it's the foundation for genuine creativity and joy.
...
Building your own resources rather than depending on or merging with others' requires patience you may not naturally have. Learning to work steadily toward financial independence and to enjoy the slow accumulation is essential growth.`,
...
Ultimately, this placement is about learning that enjoying life's simple pleasures isn't shallow - it's the point. The depth you carry doesn't require darkness to validate it. Peace is the evolved state.`,
 ...
 hook: "With North Node in Gemini, your journey is toward learning, curiosity, and open-minded communication. The comfort zone (South Node in Sagittarius) was having answers, teaching truth, and certainty - but growth requires becoming a perpetual student who questions everything.",
 
 pastLifePatterns: `The South Node in Sagittarius reveals deep-rooted patterns of being the teacher, philosopher, or guru - the one with answers, vision, and truth. You was the preacher, the adventurer, the one who knew the meaning and shared it confidently.
...
But the shadow of this pattern is dogmatism, preaching without listening, and being so certain of truth that you stop learning. Too many years of being the teacher created addiction to being right and difficulty admitting you don't know.`,
 ...
 oldComfortZone: `The Sagittarius South Node comfort zone manifests as immediately forming opinions, teaching rather than listening, and being uncomfortable with not knowing. You may find yourself automatically adopting the teacher/guru role even when it's not appropriate.
...
The old pattern is to believe you already know, that learning is beneath you, and that truth is singular rather than multifaceted. Questions feel like weakness; teaching feels like your role. The familiar territory is providing answers rather than exploring questions.`,
 ...
 newDirection: `The Gemini North Node calls you to become a perpetual student - curious, open-minded, and always learning. This means asking questions more than answering you, listening more than talking, and being comfortable with not knowing.
...
You are learning that real wisdom comes from staying curious, that preaching prevents learning, and that local, immediate experiences matter as much as grand philosophies. The teacher becomes student, and paradoxically, that makes the teaching more profound.
...
Staying present and local rather than escaping into philosophies or travel is difficult. The old pattern seeks meaning in the distance; growth requires finding it here and now in everyday interactions.`,
 ...
 relationships: `In relationships, this North Node requires learning to have conversations rather than deliver sermons. This means asking your partner questions, being genuinely curious about your perspective, and not always needing to be the wise one.

The growth edge is admitting when you're wrong, saying you don't know, and learning from your partner rather than always teaching you. It's valuing your local, practical wisdom alongside your philosophical insights.
...
Ultimately, this placement is about learning that staying curious keeps you alive and growing. The preacher who becomes student discovers truth is richer and more complex than any single philosophy can capture.`,
 ...
 southNode: "Capricorn",
 hook: "With North Node in Cancer, your journey is toward emotional connection, nurturing, and creating home. The comfort zone (South Node in Capricorn) was achievement, authority, and emotional control - but growth requires developing emotional intelligence and allowing vulnerability.",
 
 pastLifePatterns: `The South Node in Capricorn reveals deep-rooted patterns of being the authority, the achiever, the one who had it all together professionally. You was the leader, manager, or public figure whose value came through accomplishment and control.
...
But the shadow of this pattern is emotional suppression, workaholism, and inability to show vulnerability. Too many years of being the authority created disconnection from feelings and difficulty receiving care.`,
 ...
 oldComfortZone: `The Capricorn South Node comfort zone manifests as prioritizing career over family, suppressing emotions to maintain control, and measuring worth through achievement. You may find yourself automatically taking leadership roles even in personal relationships.
...
The old pattern is to believe success means career achievement, that emotions are inconvenient, and that being needed is better than needing. Home feels like a place to rest between work; family feels like a responsibility rather than a source of joy.`,
 ...
 newDirection: `The Cancer North Node calls you to develop emotional intelligence, create nurturing environments, and prioritize family and feelings. This means learning to show vulnerability, ask for emotional support, and value home life as much as career.
...
You are learning that true success includes emotional intimacy, that leadership can include vulnerability, and that creating a loving home is as important as building a career. The authority becomes caregiver, and paradoxically, that makes leadership more effective.
...
Developing emotional literacy when you were trained to suppress feelings is difficult. Learning to name emotions, express you appropriately, and value emotional intelligence as much as professional competence is essential growth.`,
...
Ultimately, this placement is about learning that creating loving home and emotional connections IS success, not something that happens after career success. The home you create becomes the foundation for all else.`,
 ...
 southNode: "Aquarius",
 hook: "With North Node in Leo, your journey is toward creative self-expression, following the heart, and individual recognition. The comfort zone (South Node in Aquarius) was the group, detachment, and suppressing individual needs - but growth requires becoming unapologetically yourself and shining.",
 
 pastLifePatterns: `The South Node in Aquarius reveals deep-rooted patterns of being part of the collective, prioritizing group over self, and maintaining emotional detachment. You was the revolutionary, the humanitarian, the one who served the many at expense of the one.
...
But the shadow of this pattern is suppressing individual needs for the group, emotional unavailability, and inability to take center stage. Too many years of serving the collective created difficulty honoring your unique heart and creative expression.`,
 ...
 oldComfortZone: `The Aquarius South Node comfort zone manifests as always thinking of the group, intellectualizing emotions, and being uncomfortable with personal recognition. You may automatically deflect attention back to the team or cause.
...
The old pattern is to believe individual needs are selfish, that emotions are illogical, and that standing out is egotistical. Heart desires feel frivolous; group consensus feels essential. The familiar territory is being one of many rather than the one.`,
 ...
 newDirection: `The Leo North Node calls you to develop creative self-expression, follow the heart even when it's not logical, and allow yourself to be seen and celebrated. This means creating for the joy of it, expressing your unique gifts, and being comfortable in the spotlight.
...
You are learning that you serve the collective better when you're expressing your unique gifts than when you're suppressing you. The most revolutionary act is sometimes being unapologetically yourself.
...
The growth edge is choosing partners who celebrate your specialness rather than those who need you to blend in or serve your cause. It's being the star sometimes rather than always the supporter.
...
Ultimately, this placement is about learning that creativity, joy, and self-expression aren't frivolous - you're the point. When you shine, you give others permission to shine too. Your individual radiance serves the whole.`,
 ...
 southNode: "Pisces",
 hook: "With North Node in Virgo, your journey is toward practical service, discernment, and grounded routines. The comfort zone (South Node in Pisces) was mysticism, escapism, and boundlessness - but growth requires developing discrimination, health habits, and useful skills.",
 
 pastLifePatterns: `The South Node in Pisces reveals deep-rooted patterns of mysticism, escapism, and merging with the divine or collective unconscious. You was the mystic, the martyr, the one who dissolved boundaries and sacrificed self for spiritual unity.
...
But the shadow of this pattern is escapism, victim mentality, and inability to function practically in the material world. Too many years of spiritual bypassing created difficulty with boundaries, discernment, and embodied living.`,
 ...
 oldComfortZone: `The Pisces South Node comfort zone manifests as escaping into spirituality, fantasy, or substances rather than dealing with practical reality. You may find yourself spacing out, avoiding details, or martyring yourself.
...
The old pattern is to believe suffering is noble, that boundaries are unspiritual, and that the material world is less real than spiritual realms. Organization feels petty; routine feels like prison. The familiar territory is beautiful confusion rather than practical clarity.`,
 ...
 newDirection: `The Virgo North Node calls you to develop practical skills, healthy routines, and discernment. This means learning to function efficiently in the material world, create order, and serve others in practical ways rather than vague spiritual ones.
...
You are learning that true service requires being functional, that compassion includes having boundaries, and that the body and material world are sacred temples requiring maintenance.
...
Ultimately, this placement is about learning that spirituality includes embodiment, that service requires skill, and that organization isn't antithetical to the divine - it honors it.`,
 ...
 southNode: "Aries",
 hook: "With North Node in Libra, your journey is toward partnership, compromise, and considering others. The comfort zone (South Node in Aries) was independence, doing things your way, and self-focus - but growth requires learning to collaborate and create harmony.",
 
 pastLifePatterns: `The South Node in Aries reveals deep-rooted patterns of independence, warrior energy, and doing things alone. You was the pioneer, the fighter, the one who forged ahead without needing anyone's help or approval.
...
But the shadow of this pattern is inability to partner, difficulty compromising, and believing you must do everything yourself. Too many years of warrior independence created blindness to others' needs and inability to share power or decision-making.`,
 ...
 oldComfortZone: `The Aries South Node comfort zone manifests as automatic independence, difficulty asking for help, and discomfort with compromise. You may find yourself acting unilaterally, not consulting others, or dominating relationships without meaning to.
...
The old pattern is to believe considering others slows you down, that compromise means losing, and that needing others means weakness. Teamwork feels frustrating; solo action feels right. The familiar territory is "my way" rather than "our way."`,
 ...
 newDirection: `The Libra North Node calls you to develop partnership skills, diplomatic communication, and genuine consideration of others' perspectives. This means learning to consult, compromise, and create win-win solutions.
...
The journey is toward discovering that partnership makes you stronger, not weaker, that others' input improves outcomes, and that considering your needs doesn't erase yours. It's learning to be "we" while honoring "me."`,
...
You are learning that true strength includes the ability to compromise, that leadership can be shared, and that beauty and harmony are worth creating. The warrior becomes diplomat, and paradoxically, that increases your effectiveness.
...
Ultimately, this placement is about learning that creating harmony and beauty is spiritual work, that compromise isn't losing, and that partnership allows you to achieve what you never could alone.`,
 ...
 southNode: "Taurus",
 hook: "With North Node in Scorpio, your journey is toward transformation, intimacy, and shared resources. The comfort zone (South Node in Taurus) was stability, simplicity, and self-sufficiency - but growth requires embracing change, depth, and interdependence.",
 
 pastLifePatterns: `The South Node in Taurus reveals deep-rooted patterns of building security, enjoying simple pleasures, and relying only on yourself. You was the farmer, artisan, or builder who created stability through your own steady effort.
...
But the shadow of this pattern is resistance to change, avoiding depth to maintain comfort, and inability to merge or share resources. Too many years of safe stability created fear of transformation and difficulty with intimacy.`,
 ...
 oldComfortZone: `The Taurus South Node comfort zone manifests as clinging to security, avoiding anything that threatens stability, and keeping relationships surface-level. You may find yourself accumulating possessions, resisting change, or staying in comfort zone even when growth calls.
...
The old pattern is to believe safety requires avoiding depth, that change is dangerous, and that depending on others' resources or energies is risky. Transformation feels like loss; stability feels essential. The familiar territory is pleasant surface rather than transformative depth.`,
 ...
 newDirection: `The Scorpio North Node calls you to embrace transformation, develop psychological depth, and merge resources and energies with others. This means being willing to let things die so new forms can emerge, diving into emotional depths, and becoming interdependent.
...
You are learning that real security comes from capacity to transform, not from avoiding change. True wealth is sometimes found in merging resources. The deepest pleasures require vulnerability.
...
Developing intimacy that requires vulnerability and merging is another major hurdle. The Taurus pattern wants independence; growth requires sometimes depending on others and allowing you to see your shadows.
...
Ultimately, this placement is about learning that intensity and transformation aren't threats - you're gateways to power and depth you can't access from comfort zone. You must die to be reborn.`,
 ...
 southNode: "Gemini",
 hook: "With North Node in Sagittarius, your journey is toward faith, meaning, and expansive truth. The comfort zone (South Node in Gemini) was gathering information, staying local, and intellectual curiosity - but growth requires developing wisdom, teaching, and having faith in larger truth.",
 
 pastLifePatterns: `The South Node in Gemini reveals deep-rooted patterns of constant learning, information gathering, and intellectual exploration without ever synthesizing it into wisdom. You was the student, messenger, or communicator who knew many things but lacked overarching philosophy.
...
But the shadow of this pattern is perpetual student who never becomes teacher, gathering information without finding meaning, and intellectual restlessness that prevents depth. Too many years of questions without answers created inability to commit to truth.`,
 ...
 oldComfortZone: `The Gemini South Node comfort zone manifests as perpetual information gathering, difficulty forming firm opinions, and intellectual approach to everything. You may find yourself constantly learning but never teaching, always having more questions, unable to commit to philosophy or truth.
...
The old pattern is to believe there's always more to learn before you can teach, that committing to truth is close-minded, and that local/familiar is safer than distant/unknown. Philosophy feels pretentious; facts feel trustworthy. The familiar territory is intelligent questions rather than wise answers.`,
 ...
 newDirection: `The Sagittarius North Node calls you to synthesize information into wisdom, commit to truth even if imperfect, and teach others from your learning. This means developing faith in larger meaning, seeking adventure and expansion, and being willing to have answers.
...
You are learning that gathering information without finding meaning leaves you empty. True intelligence includes faith. The student who becomes teacher discovers the deepest learning happens through teaching.
...
Ultimately, this placement is about learning that teaching deepens your learning, that adventure expands your consciousness, and that faith in meaning makes life rich. You honor your learning by sharing wisdom.`,
 ...
 southNode: "Cancer",
 hook: "With North Node in Capricorn, your journey is toward professional achievement, authority, and emotional discipline. The comfort zone (South Node in Cancer) was family, emotions, and being taken care of - but growth requires becoming the authority and achieving public success.",
 
 pastLifePatterns: `The South Node in Cancer reveals deep-rooted patterns of nurturing others, prioritizing family, and being the emotional center. You was the mother, caregiver, or emotional foundation who everyone depended on for nurturance.
...
But the shadow of this pattern is emotional dependency, inability to leave family/home, and avoiding professional achievement out of guilt or fear. Too many years of being needed emotionally created difficulty achieving outside of family context.`,
 ...
 oldComfortZone: `The Cancer South Node comfort zone manifests as prioritizing family over career, being emotionally enmeshed, and avoiding public roles. You may find yourself always being the nurturer, staying home, or feeling guilty about professional ambition.
...
The old pattern is to believe family should always come first, that professional success means abandoning loved ones, and that being needed emotionally is your value. Authority feels cold; nurturing feels like your role. The familiar territory is private emotional life rather than public achievement.`,
 ...
 newDirection: `The Capricorn North Node calls you to develop professional competence, achieve public recognition, and become an authority. This means prioritizing career sometimes, developing emotional discipline, and being the one in charge.
...
You are learning that you can love family AND achieve professionally. Authority can be nurturing. The caregiver who becomes leader discovers you serve more people from position of authority.
...
Ultimately, this placement is about learning that professional success and family love aren't mutually exclusive. When you achieve, you model possibility for those you love. Your authority serves the world.`,
 ...
 southNode: "Leo",
 hook: "With North Node in Aquarius, your journey is toward collective consciousness, innovation, and emotional detachment. The comfort zone (South Node in Leo) was personal recognition, creative drama, and being the star - but growth requires serving the collective and releasing need for applause.",
 
 pastLifePatterns: `The South Node in Leo reveals deep-rooted patterns of creative expression, receiving recognition, and being center stage. You was the king, performer, or creative genius whose value came through individual brilliance and personal love.
...
But the shadow of this pattern is addiction to recognition, drama, and inability to think of the collective. Too many years of being the star created need for constant attention and difficulty with group consciousness.`,
 ...
 oldComfortZone: `The Leo South Node comfort zone manifests as needing to be center of attention, making everything dramatic and personal, and measuring worth through recognition. You may find yourself automatically taking lead, seeking applause, or creating drama to feel alive.
...
The old pattern is to believe your individual expression is most important, that recognition validates your worth, and that group consciousness means losing yourself. Being ordinary feels like death; being special feels essential. The familiar territory is "look at me" rather than "what serves the whole?"`,
 ...
 newDirection: `The Aquarius North Node calls you to develop collective consciousness, innovative thinking, and emotional detachment. This means considering what serves the group, releasing need for personal recognition, and using your gifts to benefit humanity.
...
You are learning that you serve better when you're thinking of the group, that innovation requires releasing personal drama for intellectual clarity, and that true revolution comes from collective action, not individual glory.
...
Ultimately, this placement is about learning that being part of humanity's forward movement is more meaningful than being the star. When you serve the future, you become immortal in ways personal glory never achieves.`,
 ...
 southNode: "Virgo",
 hook: "With North Node in Pisces, your journey is toward faith, compassion, and surrender to something greater. The comfort zone (South Node in Virgo) was analysis, perfection, and control - but growth requires releasing into mystery and trusting the unseen.",
 
 pastLifePatterns: `The South Node in Virgo reveals deep-rooted patterns of analysis, service, and perfectionism. You was the healer, craftsperson, or analyst whose value came through skill, discernment, and fixing problems.
...
But the shadow of this pattern is over-analysis, criticism, and inability to surrender to faith. Too many years of trying to perfect and control created anxiety, inability to trust, and disconnection from spiritual mystery.`,
 ...
 oldComfortZone: `The Virgo South Node comfort zone manifests as analyzing everything, trying to fix and perfect, and being anxious about details. You may find yourself unable to relax, constantly criticizing self and others, or trying to control outcomes through preparation.
...
The old pattern is to believe you must earn your place through usefulness, that surrender means irresponsibility, and that mystery is uncomfortable. Perfection feels essential; accepting flaws feels like failure. The familiar territory is anxious control rather than peaceful surrender.`,
 ...
 newDirection: `The Pisces North Node calls you to develop faith, compassion, and surrender to mystery. This means releasing need to understand and control everything, trusting the unseen, and serving through spiritual rather than just practical means.
...
You are learning that true healing includes the spiritual, that perfect technique without compassion doesn't serve, and that surrendering control allows divine grace to work through you.
...
var DEEP_SOUTH_NODE_READINGS = {
 ...
 northNode: "Libra",
 hook: "With South Node in Aries, you's natural strengths were built through independence, courage, and self-assertion. You came into this life knowing how to stand alone, act decisively, and prioritize yourself - now you're learning partnership and consideration of others.",
...
Your ability to stand alone serves when everyone else is looking for someone else to take charge. Your decisiveness serves when action is needed immediately. Your self-reliance serves when resources are scarce and everyone must fend for yourself.
...
The warrior independence that once ensured survival now creates loneliness and conflict. What was mastery in past lives becomes obstacle in this one when relationship and harmony are the growth edges.`,
 ...
 shadowExpression: `The shadow of Aries South Node is selfishness, impulsiveness, and inability to collaborate. You may find yourself dominating relationships without meaning to, making decisions that affect others without consulting you, or feeling annoyed by others' needs.
...
The most powerful expression is using your warrior strength to fight FOR relationship rather than dominance, to courageously engage in the vulnerability partnership requires. You become the strong partner who chooses collaboration from power, not need.`,
 ...
 evolutionPath: `Evolution means recognizing when the Aries pattern serves and when it limits. It's learning to still access courage and independence but not default to you in every situation.
...
This lifetime is about discovering that the next level of evolution includes others. Not losing yourself in you (Cancer South Node's lesson) but maintaining yourself while creating union. The spiritual warrior who learns diplomacy.
...
The deeper teaching is that true strength includes the ability to compromise, true leadership includes following sometimes, and the highest expression of independence is choosing interdependence from wholeness.`,
 ...
 northNode: "Scorpio",
 hook: "With South Node in Taurus, you's natural strengths were built through building security, enjoying simple pleasures, and cultivating self-sufficiency. You came into this life knowing how to create stability through your own effort - now you're learning transformation and shared resources.",
...
The most powerful expression is using your building capacity to create transformation that lasts - not burning everything down but consciously evolving. You become the stable force who can handle profound change.`,
 ...
 evolutionPath: `Evolution means recognizing when Taurus pattern serves and when it limits. It's learning to still access stability and patience but not let you prevent necessary transformation.
...
The deeper teaching is that transformation isn't destruction - it's evolution. And that the ultimate security comes not from what you accumulate but from your capacity to transform and be reborn.`,
 ...
 hook: "With South Node in Gemini, you's natural strengths were built through gathering information, communicating, and staying curious. You came into this life knowing how to learn and ask questions - now you're learning to teach and commit to truth.",
...
The pattern limits evolution when you intellectualize emotions rather than feeling you, stay local when expansion is needed, or know many things without finding overarching meaning. Relationships stay surface when you analyze rather than connecting through shared philosophy.
...
The darkest shadow is meaninglessness - accumulating information without finding truth, being so open-minded that nothing has value, intellectualizing life rather than living it. The student who never becomes teacher because you never admit you know enough.`,
...
The most powerful expression is using your learning capacity to absorb wisdom traditions, then teaching you accessibly. You become the wise teacher who remains humble student - the highest Sagittarian expression.`,
...
The deeper teaching is that sometimes you must commit to truth even when you can still see other perspectives. And that teaching what you know deepens your learning more than gathering more information.`,
 ...
 northNode: "Capricorn",
 hook: "With South Node in Cancer, you's natural strengths were built through nurturing, creating home, and being emotionally available. You came into this life knowing how to care for others and create belonging - now you're learning professional achievement and emotional discipline.",
...
The darkest shadow is emotional dependency disguised as caregiving - needing to be needed, keeping others small so you can nurture you, avoiding your own ambitions to stay in the comfortable caregiver role.`,
...
The deeper teaching is that you serve family better when you're fulfilled professionally. And that true love includes encouraging those you care for to achieve, not just keeping you safe and comfortable.`,
 ...
 northNode: "Aquarius",
 hook: "With South Node in Leo, you's natural strengths were built through time in the spotlight, expressing creatively, and receiving recognition. You came into this life knowing how to shine and be special - now you're learning to serve the collective and release need for applause.",
...
The star pattern that once brought joy now creates isolation. What was mastery in past lives becomes obstacle when serving humanity and releasing ego are the growth edges.`,
 ...
 shadowExpression: `The shadow of Leo South Node is narcissism, drama addiction, and inability to think beyond yourself. You may find yourself creating drama to feel alive, needing constant validation, or being the "star" who makes the team about you.
...
The darkest shadow is empty recognition - being celebrated but feeling hollow, having admirers but not equals, being the star who's ultimately alone because you can't step out of the spotlight long enough to be one of the team.`,
...
The deeper teaching is that you become immortal not through being remembered as individual, but through contributing to humanity's evolution. And that serving the future with your creativity is more fulfilling than any personal recognition.`,
 ...
 northNode: "Pisces",
 hook: "With South Node in Virgo, you's natural strengths were built through analysing, perfecting, and serving practically. You came into this life knowing how to fix problems and be useful - now you're learning to surrender to faith and trust the mystery.",
...
The ease with which you can analyze, organize, and perfect is your gift. But it becomes problematic when you can't surrender to mystery, when criticism prevents compassion, or when perfectionism creates anxiety. The pattern that once created excellence now prevents peace.`,
 ...
 whenItServes: `The Virgo South Node serves you in situations requiring analysis, practical service, or attention to detail. When systems need organizing, you excel. When problems need practical solutions, you can provide you.
...
The deeper teaching is that divine plan includes imperfection, that grace works beyond your technique, and that trusting the unseen is the ultimate skill. And that serving with faith is more powerful than serving with anxiety.`,
 ...
 northNode: "Aries",
 hook: "With South Node in Libra, you's natural strengths were built through creating harmony, partnering, and considering others. You came into this life knowing how to compromise and maintain peace - now you're learning to be independent and put yourself first.",
...
The most powerful expression is using your diplomatic gifts while maintaining strong self - becoming the graceful warrior, the diplomatic leader, the person who can fight fairly because you've mastered peace. You bring beauty to battle.`,
...
The deeper teaching is that true partnership requires two whole people, that harmony created through self-sacrifice isn't real harmony, and that learning to stand alone makes you better partner. And that your independence serves love better than your accommodation.`,
 ...
 northNode: "Taurus",
 hook: "With South Node in Scorpio, you's natural strengths were built through intensity, transformation, and merging with others. You came into this life knowing depth and crisis - now you're learning to find peace in simplicity and build your own security.",
...
The deeper teaching is that you've transformed enough - now it's time to enjoy the fruit of that work. And that building something stable and beautiful in the material world is the next level of spiritual work. And that self-sufficiency is power too.`,
 ...
 northNode: "Gemini",
 hook: "With South Node in Sagittarius, you's natural strengths were built through teaching truth, seeking meaning, and having faith. You came into this life knowing the big picture - now you're learning to stay curious, ask questions, and appreciate local details.",
...
Success looks like: accessing vision when it serves but staying curious; maintaining teaching ability while being perpetual student; having philosophical framework while remaining open to new information; inspiring others while learning from you.`,
 
 relationshipPattern: `In relationships, the Sagittarius South Node pattern is always being the wise one, needing freedom and adventure, and teaching your partner rather than learning from you. You may find yourself preaching, being the one with answers, or escaping into philosophy when emotional presence is needed.
...
The deeper teaching is that your teaching deepens when you remain open to learning, that truth is richer when you explore multiple perspectives, and that the local and immediate are as sacred as the distant and philosophical. And that the ultimate wisdom is knowing you don't know.`,
 ...
 northNode: "Cancer",
 hook: "With South Node in Capricorn, you's natural strengths were built through achieving, leading, and maintaining control. You came into this life knowing how to succeed professionally - now you're learning emotional availability and the value of family and home.",
...
The darkest shadow is empty success - achieving everything professionally but having no emotional connections, being respected but not loved, being the authority who's ultimately alone because you couldn't show your heart.`,
...
The deeper teaching is that you've achieved enough professionally - now it's time to develop emotional dimension. And that showing your heart doesn't diminish your authority - it makes you complete. And that being needed emotionally is as valuable as being respected professionally.`,
 ...
 northNode: "Leo",
 hook: "With South Node in Aquarius, you's natural strengths were built through serving the collective, innovating for humanity, and maintaining emotional detachment. You came into this life knowing about group consciousness - now you're learning to honor your individual heart and creative expression.",
...
The deeper teaching is that you serve humanity best when you're honoring your unique creative expression, that passion is wisdom, and that being celebrated for your individuality doesn't diminish you - it completes you. And that your heart is as important as your ideals.`,
 ...
 northNode: "Virgo",
 hook: "With South Node in Pisces, you's natural strengths were built through spiritual exploration, surrendering to faith, and merging with something greater. You came into this life knowing mysticism - now you're learning practical skill and grounded service.",
...
// Export for use in main reading system
if (typeof module !== 'undefined' && module.exports) {
 module.exports = { DEEP_NORTH_NODE_READINGS, DEEP_SOUTH_NODE_READINGS };
}
