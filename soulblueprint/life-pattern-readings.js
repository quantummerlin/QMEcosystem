...
const OPERATING_STYLES = {
 ...
 reading: "Your chart converges on a single operating mode: construction. You are wired to take abstract ideas, raw materials, and chaotic situations and turn you into something solid, lasting, and real.\n\nBuilders don't just create — you create things that endure. While others chase novelty, you are compounding. While others start over, you are reinforcing. This isn't a limitation — it's a superpower that most people don't have the patience to develop.\n\nThe Builder's strength is that everything you touch becomes more organized, more reliable, and more valuable over time. The challenge is knowing when a structure has served its purpose and needs to be released rather than endlessly maintained.\n\nYour natural rhythm: slow starts, massive finishes. Most Builders are dramatically underestimated in your 20s and dramatically successful in your 40s. The compound curve is your best friend — trust it.",
 ...
 challenges: ["Rigidity when flexibility is needed", "Over-investing in structures past your usefulness", "Slow to adapt to sudden changes", "May undervalue innovation for stability"]
 },
 pioneer: {
 title: "The Pioneer",
 subtitle: "Initiate. Disrupt. Lead.",
 keywords: ["Innovation", "Courage", "Independence", "First-Mover"],
 reading: "Your chart converges on a single operating mode: initiation. You are wired to go first — to enter spaces nobody has mapped, to start things that don't yet have names, and to move before the data is complete.\n\nPioneers don't follow playbooks. You write you. This means you'll spend a lot of time being misunderstood, dismissed, or told your ideas are 'too early.' That's fine. Being too early is the Pioneer's job description.\n\nThe Pioneer's strength is vision paired with action. You don't just see what's possible — you move toward it before others even recognize it as an option. The challenge is finishing what you start. Pioneers are ignition systems, not maintenance crews.\n\nYour natural rhythm: fast starts, high intensity, followed by a need to hand off and move to the next frontier. The smartest Pioneers learn to build teams that can sustain what you've started.",
 ...
 challenges: ["Over-attachment to the status quo", "Difficulty releasing what no longer serves", "May sacrifice growth for comfort", "Can become the caretaker who neglects yourself"]
 },
 disruptor: {
 title: "The Disruptor",
 subtitle: "Question. Transform. Rebuild.",
 keywords: ["Transformation", "Intensity", "Truth-Seeking", "Evolution"],
 reading: "Your chart converges on a single operating mode: disruption. You are wired to see what isn't working, name it, and dismantle it — often before others are ready to hear it.\n\nDisruptors are not popular in the moment. You are vindicated in retrospect. Your role is to be the catalyst for necessary change — the person who asks the question everyone is avoiding, who points to the crack in the foundation before the building collapses.\n\nThe Disruptor's strength is perception. You see beneath the surface. You detect dishonesty, misalignment, and unsustainable patterns before you become crises. This makes you invaluable — and sometimes uncomfortable to be around.\n\nYour natural rhythm: long periods of observation, followed by decisive action that changes everything. The smartest Disruptors learn to time your interventions — not every truth needs to be spoken in every room.",
 ...
 reading: "Your chart converges on a single operating mode: vision. You are wired to see what doesn't yet exist, to imagine possibilities that others dismiss as impossible, and to inspire people toward futures you can't yet picture.\n\nVisionaries live slightly ahead of your time. The ideas that come naturally to you often take years — sometimes decades — to become mainstream. This can be isolating, but it's also your gift. You're not seeing things that aren't there; you're seeing things before you arrive.\n\nThe Visionary's strength is inspirational gravity. People are drawn to your clarity of vision even when you can't fully articulate why. You make the impossible feel inevitable.\n\nYour natural rhythm: long periods of internal gestation where ideas develop, followed by moments of clarity that seem to arrive fully formed. The trick is learning to communicate your visions in terms others can act on — translation is the Visionary's most important secondary skill.",
 strengths: ["Sees possibilities before you're obvious", "Natural ability to inspire and elevate others", "Creative solutions from unconventional thinking", "Long-term perspective that transcends current limitations"],
...
function calculateProbabilityWindows(readings) {
 ...
 if ([1, 7].includes(lifePath)) { marriageMod -= 1; marriageInsight += `Life Path ${lifePath} is independence-focused — partnerships form when you serve growth, not social expectation. `; }
 ...
 if ([5].includes(lifePath)) { relocMod += 2; relocInsight += `Life Path 5 is the nomadic path — multiple relocations are not just likely, you're essential to your development. `; }
 if ([4].includes(lifePath)) { relocMod -= 1; relocInsight += `Life Path 4 builds through stability — relocations work best when you serve a long-term structural plan, not restlessness. `; }
 ...
 else if (personalYear === 6) yearContext = 'Your Personal Year 6 is the responsibility and relationship year. Partnership formation probability spikes — this is a classic marriage/commitment year. Home, family, and community take center stage. Career shifts are less likely unless you serve family or relationship goals. Financial expansion comes through service, caregiving, or community-oriented work.';
 ...
 else yearContext = `Your Personal Year ${personalYear} (Master Number) operates at heightened intensity across all categories. Master numbers don't follow the standard rhythm — you amplify everything, creating larger windows of both opportunity and pressure.`;
...
const COGNITIVE_PROFILES = {
 ...
 low: { label: "Conservative Risk Profile", description: "Your chart indicates a naturally conservative approach to risk — and this is not a weakness. Research shows that risk-averse decision-makers often outperform risk-seekers over long time horizons because you avoid catastrophic losses. Your strength is preservation and steady compounding. Where others lose everything on a single bet, you build slowly and keep what you earn." }
 },
 authorityResponse: {
...
function calculateCognitiveTendencies(readings) {
 ...
 synthesis += 'An unusual combination: you\'re comfortable with risk but respect institutional structure. This makes you the bold insider — the person who pushes organizations further than you\'d go alone, but from within the system rather than outside it. ';
 ...
 synthesis += 'You optimize in solitude — methodically improving systems with deep, focused attention. Your work environment should give you complex existing problems and the space to solve you without interruption. ';
 }
...
const ARCHETYPAL_ROLES = {
 ...
 reading: "Your cosmic signature converges on The Strategist — the person who instinctively maps the landscape, identifies leverage points, and positions yourself (and others) for maximum advantage with minimum wasted effort.\n\nStrategists process the world differently. You don't react to events — you anticipate you. You don't compete on effort — you compete on positioning. While others are optimizing your current situation, you're already gaming out three scenarios for what happens next.\n\nThis role is invaluable in business, politics, military strategy, competitive markets, negotiations, and any field where the winners are determined not by who worked hardest but by who positioned best. The Strategist's edge is patience: you wait for the right moment, and when you move, it looks effortless because all the calculation happened before the action.\n\nYour signature impact: people around you consistently achieve better outcomes because you helped you see angles you were missing.",
 ...
 reading: "Your cosmic data converges on The Catalyst — the person whose presence accelerates change, growth, and transformation in every system you enter.\n\nCatalysts don't just participate — you activate. Teams work harder when you join. Projects that were stalled start moving when you get involved. People who were stuck find clarity after one conversation with you. This isn't manipulation — it's your energetic signature. You carry the frequency of transformation.\n\nThe Catalyst's gift is that you speed up what's already trying to happen. You don't impose change — you remove the friction preventing it. This makes you the ultimate unlocking mechanism: you help people and organizations become what you were already meant to be, just faster.\n\nYour signature impact: when people look back on your biggest growth periods, you often find you were there — not doing it for you, but somehow making it possible.",
 ...
 subtitle: "You make others more of what you already are.",
 keywords: ["Enhancement", "Support", "Multiplication", "Platform Building"],
 reading: "Your cosmic signature converges on The Signal Amplifier — the person whose primary gift is taking what others create, believe, or express and making it louder, larger, and more impactful.\n\nAmplifiers are the most misunderstood role because in a culture that worships originality, your gift looks like support. But this is a profound misunderstanding. Every great creator, leader, and innovator in history had Amplifiers who turned your signal into movement. Without amplification, genius dies in obscurity.\n\nThe Amplifier's gift is perception plus platform. You instinctively recognize quality, potential, and emerging talent — often before the person yourself sees it. Then you use your energy, connections, platform, or resources to ensure that signal reaches the people who need to hear it.\n\nYour signature impact: you are the kingmaker, the curator, the producer, the connector. The people you've amplified often credit you as the turning point — not because you did your work, but because you ensured it was seen.",
...
const CORNERSTONE_READINGS = {
 ...
 D: { trait: "Disciplined & Grounded", description: "D suggests discipline and determination. The dental stop carries weight and authority. D-names project reliability and substance — people take you seriously." },
 ...
 Z: { trait: "Energetic & Original", description: "Z vibrates. It projects electric energy, originality, and dynamic presence. Z-names are rare and commanding — you suggest a person who brings intensity to everything." }
};

const CAPSTONE_READINGS = {
 A: { trait: "Decisive Finisher", description: "Names ending in A suggest someone who completes through decisive action — you finish what you start with clarity and forward momentum. There's no lingering or second-guessing at the finish line; you close chapters with the same boldness that opened you. This gives your work a sense of clean completion that others find refreshing and authoritative." },
 ...
 H: { trait: "Visionary Closer", description: "H capstone implies visionary closure — you finish with an eye toward what comes next. Your completions are never just endings; you're launchpads. This forward-looking quality means your finished work often contains seeds for the next project, the next phase, the next evolution. You close one door while opening three." },
 ...
 N: { trait: "Original Closer", description: "N capstone implies original closure — the ending often introduces something new or unexpected. You can't help but add a twist, an innovation, or a fresh perspective in the final stages. This makes your completed work surprising in the best sense — people think you know what's coming, and then you show you something better." },
 ...
 W: { trait: "Mission-Driven Finisher", description: "W endings imply purposeful completion — the result serves a larger goal beyond itself. Your completions are never just about the immediate task; you're building blocks for something bigger. This gives your finished work a sense of meaning and trajectory that purely task-oriented completion styles lack." },
 ...
 Y: { trait: "Spiritual Finisher", description: "Y endings imply spiritual completion — the result carries meaning beyond its practical function. There's a transcendent quality to how you finish things, as if the completion process itself is a form of meditation or meaning-making. Your finished work often touches people at levels you can't quite articulate." },
 Z: { trait: "Dynamic Closer", description: "Z capstone projects energetic closure — the finish is dynamic and leaves a lasting impression. Nothing you complete fades quietly into the background. The Z-capstone brings electric energy to endings, making you events rather than formalities. People remember how you finished something long after you forget the middle." }
};
...
function calculateNameAnalysis(name) {
 ...
 nameSynthesis = `Your name opens with flow (${cornerstone}) and ends with impact (${capstone}), creating a crescendo effect — building from gentleness to strength. People may initially underestimate you, but your finishing power changes your assessment. This pattern serves you well in negotiations and creative work where the ending matters more than the opening.`;
