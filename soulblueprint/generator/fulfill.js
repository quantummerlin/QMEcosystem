...
/* Welcome overlay */
.welcome-overlay{position:fixed;top:0;left:0;right:0;bottom:0;background:linear-gradient(145deg,rgba(10,5,20,0.97),rgba(26,10,46,0.98));z-index:9999;display:flex;align-items:center;justify-content:center;padding:24px 16px;opacity:1;transition:opacity 0.6s ease;font-family:'Inter','Segoe UI',system-ui,sans-serif}
...
.welcome-btn{display:inline-block;background:linear-gradient(135deg,#ffd700 0%,#e6ac00 40%,#ffd700 60%,#ffe44d 80%,#ffd700 100%);background-size:200% auto;color:#1a0a2e;padding:16px 44px;border-radius:30px;font-size:1.05rem;font-weight:700;text-decoration:none;border:none;cursor:pointer;box-shadow:0 4px 24px rgba(255,215,0,0.3);transition:transform 0.2s,box-shadow 0.2s;animation:welcomeFadeIn 0.5s ease-out 0.8s both,welcomeShimmer 3s ease-in-out infinite}
.welcome-btn:hover{transform:translateY(-2px);box-shadow:0 8px 32px rgba(255,215,0,0.4)}
.welcome-note{font-size:0.72rem;opacity:0.35;margin-top:16px;animation:welcomeFadeIn 0.5s ease-out 0.9s both}
