...
.welcome-card{max-width:440px;width:100%;background:linear-gradient(160deg,rgba(30,16,53,0.95),rgba(18,8,42,0.98));border:none;border-radius:28px;padding:40px 32px;margin:15vh auto 40px;text-align:center;box-shadow:0 24px 80px rgba(0,0,0,0.5),0 0 80px ${tc.glow};position:relative;overflow:visible;animation:welcomeFadeIn 0.8s ease-out}
.welcome-card::before{content:'';position:absolute;inset:-2px;border-radius:30px;background:linear-gradient(145deg,${tc.signColor},rgba(255,215,0,0.35),${tc.label},rgba(255,215,0,0.2),${tc.signColor});z-index:-1;opacity:0.7}
.welcome-card::after{content:'';position:absolute;inset:1px;border-radius:27px;border:1px solid ${tc.border};pointer-events:none;z-index:2}
