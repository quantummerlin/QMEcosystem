...
BRANDS = {
    "classic/readings/index.html": {
        ...
        "description": "Get 65+ personalized readings combining numerology, astrology, and cosmic wisdom. Enter your birth data once and explore your complete cosmic profile. Free, no sign-up.",
        "keywords": "quantum merlin, numerology reading, astrology reading, birth chart, life path number, free reading, cosmic profile",
        "canonical": "https://quantummerlin.com/classic/readings/",
        "theme_color": "#bf5af2",
        "app_title": "Quantum Merlin",
        "tile_color": "#bf5af2",
        "json_ld_name": "Quantum Merlin — Cosmic Reading",
        "og_image": "https://quantummerlin.com/classic/RetroMerlin.jpg",
        "og_alt": "Quantum Merlin — Cosmic Reading",
...
def rebrand_meta(filepath, brand):
    ...
    # JSON-LD
    content = re.sub(
        r'"name":\s*"[^"]*Cosmic Reading[^"]*"',
        f'"name": "{brand["json_ld_name"]}"',
        content, count=1
    )
    content = re.sub(
        r'"description":\s*"Discover your [^"]*"',
