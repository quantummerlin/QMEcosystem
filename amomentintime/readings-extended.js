...
var NODES_IN_HOUSES = {
 ...
 reading: `The North Node in the 1st House marks one of the most personal growth paths possible: learning to exist as a distinct individual, to act from personal desire rather than obligation, and to discover that "selfish" isn't always a dirty word. With the South Node in the 7th House, you have always been defined by relationships — merging, accommodating, compromising until the original self became almost invisible.
...
<strong>The Deep Pattern:</strong> The South Node in the 8th House carries a deep familiarity with intensity — a life shaped by inheritance, shared finances, power dynamics, and psychological depth. You know how to merge with others, how to navigate crisis, how to transform through destruction and rebirth. You may be natural healers, therapists, or those who manage others' resources. The comfort zone is depth, intensity, and complexity.
...
var COSMIC_WRAPUP = {
 ...
 What follows is ${name}'s energetic birth certificate—the moment in time that describes not who you must become, but who you already ARE at your deepest level. These patterns don't limit; you illuminate. You don't predict; you empower.`;
