...
Ésta es la mente del iniciador. Mientras otros todavía están recopilando datos, Mercurio en Aries ya se ha formado una opinión y ha comenzado a actuar en consecuencia. Esto no es impulsividad (aunque pueda parecerlo): es una relación diferente con el tiempo. Esta alma confía en que el primer instinto muchas veces es el correcto.`,
...
Respete su ritmo mientras los expone suavemente a nuevas ideas. Planta semillas de nuevos conceptos y déjalas crecer gradualmente. Evite las luchas de poder intelectual: le sobrevivirán. En su lugar, ofrezca pruebas y tiempo para su consideración.`,
    ...
    Gemini: {
        ...
        coreNature: `Mercurio en Géminis es Mercurio en casa: la mente operando de la forma más natural y versátil. Esta alma piensa en redes en lugar de líneas, y ve conexiones que otros pasan por alto por completo. Múltiples corrientes de pensamiento funcionan simultáneamente, lo que hace que esta mente sea extraordinariamente ágil y curiosa.

Ésta es la mente del mensajero. La información quiere moverse a través de ellos, entrando y saliendo, fluyendo constantemente. Son traductores naturales entre diferentes mundos, diferentes idiomas, diferentes formas de pensar. El aburrimiento es su enemigo; la variedad es su oxígeno.`,
...
La memoria es excepcional, especialmente para información emocionalmente significativa. Es posible que recuerden exactamente cómo les hizo sentir algo décadas después. Las historias, la historia familiar y el material personalmente significativo los involucran más profundamente.`,
...
Tienen un orgullo intelectual genuino y trabajarán duro para demostrar su valor mental. La competencia motiva cuando creen que pueden ganar. Necesitan estímulo para persistir cuando el aprendizaje les resulta difícil y poco atractivo.`,
        ...
        challenges: `La sombra de esta ubicación es la arrogancia intelectual. Es posible que descarten las ideas de los demás demasiado rápido, convencidos de su propia superioridad. Cuando el orgullo resulta herido, es posible que se cierren en lugar de permanecer abiertos al aprendizaje.
...
Esta es la mente del detective. El por qué es sólo el comienzo de sus preguntas. Necesitan comprender la causa raíz, el patrón subyacente, la verdad secreta. Las respuestas a medias los frustran; Cavarán hasta llegar al lecho de roca.`,
...
Enséñeles límites saludables en el cuidado: que pueden amar a las personas sin perderse a sí mismos. Ayúdelos a procesar y liberar viejas heridas en lugar de almacenarlas para siempre. Modelo de que es seguro amar sin garantías.`,
    ...
    Leo: {
        ...
        coreNature: `Venus en Leo ama con la calidez y generosidad del propio sol. Esta alma da amor de manera abundante, dramática y con alegría incondicional. Quieren adorar y ser adorados, celebrar el amor como la mayor aventura de la vida.
...
Necesitan confiabilidad y esfuerzo. Los grandes gestos significan menos que un cuidado diario y consistente. Respetan a las parejas que también hacen el trabajo de la relación, que no les dejan todo.`,
...
Enséñeles que se puede recuperar la confianza después de una decepción. Ayúdelos a expresar los celos y la posesividad con palabras en lugar de acciones. Modele que el amor incluye el perdón y que la vulnerabilidad no significa debilidad.`,
    ...
    Sagittarius: {
        ...
        hook: "Una naturaleza de amor que se expande, explora e inspira.",
...
Enséñeles que el fracaso es parte del éxito, que la valentía incluye intentarlo incluso cuando ganar no está garantizado. Ayúdelos a compartir el crédito y a disfrutar también de los logros de los demás.`,
        ...
        affirmation: "Mi corazón valiente impulsa mis acciones. Hago brillar mi luz mientras celebro el brillo de los demás también."
    },
...
Sobresalen en cualquier cosa que requiera intensidad, investigación, investigación o conocimiento psicológico. Ven lo que está oculto y persiguen lo que otros han abandonado.`,
        ...
        challenges: `La sombra de esta ubicación es la obsesión y la venganza. Pueden perseguir objetivos o rencores más allá de lo razonable, incapaces de liberarse incluso cuando aferrarse es claramente destructivo.
...
Enséñeles que dejar ir es a veces el mayor poder. Ayúdelos a reconocer cuando la intensidad se convierte en obsesión. Modele la expresión saludable de emociones difíciles.`,
    ...
    Sagittarius: {
        ...
        hook: "Poder que se expresa a través de la expansión y la inspiración.",
...
Enséñales a terminar lo que empiezan, al menos algunas veces. Ayúdelos a ver que otros también tienen perspectivas válidas. Equilibre su optimismo con comprobaciones prácticas de la realidad sin aplastar su espíritu.`,
        ...
        affirmation: "Mi energía aventurera amplía horizontes. Inspiro con mi fuego respetando el camino de los demás."
    },
    
    Capricorn: {
        title: "La fuerza del logro",
        hook: "Poder expresado a través de la disciplina y el dominio.",
        coreNature: `Marte en Capricornio es el ejecutivo y aplica energía estratégicamente hacia logros a largo plazo. Esta alma juega a largo plazo, dispuesta a trabajar persistentemente para alcanzar metas que pueden tardar años en lograrse. Su poder está en su disciplina.
...
Son artistas y sanadores naturales que canalizan energía a través de la expresión creativa y compasiva. Su enfoque es indirecto pero puede resultar sorprendentemente eficaz.`,
