...
var DEEP_MOON_READINGS = {
    "Aries": {
        title: "El guerrero emocional",
        hook: "Esta alma siente todo con urgencia y fuego: las emociones golpean rápidamente, arden con intensidad y avanzan rápidamente. Su mundo interior es un campo de batalla de sentimientos apasionados que exigen una expresión inmediata.",
        ...
        strength: "La capacidad de sentir miedo y actuar de todos modos. Este niño tiene un coraje emocional que le servirá durante toda la vida. Pueden afrontar sentimientos difíciles de frente en lugar de evitarlos. Su honestidad sobre las emociones crea conexiones genuinas.",
        shadow: "El patrón de sombra: ira reactiva e impulsividad emocional. Es posible que arremetan antes de pensar, digan cosas hirientes en el calor del momento o inicien conflictos de los que luego se arrepientan. Impaciencia con procesadores emocionales más lentos.",
        integration: "Help them learn that pausing before reacting isn't weakness — it's wisdom. Channel their fiery emotions into physical outlets. Teach that other people's slower emotional pace isn't wrong, just different.",
        stress: "Bajo presión, se vuelven combativos, impacientes y de mal genio. Pueden buscar peleas, volverse físicamente agresivos o rechazar el consuelo que les parece debilidad. La necesidad de independencia se intensifica.",
        misread: "People may see them as too intense or angry when they're actually just being emotionally authentic in a world that often suppresses feelings. Their directness gets labeled as aggression.",
        relationships: "Necesitan socios y amigos que puedan manejar su intensidad sin intentar calmarlos. Respetan la honestidad emocional y la franqueza. Jugar juegos emocionales hará que pierdan el interés inmediatamente.",
        ...
        power: "When they fully own their emotional warrior nature, they become champions for others who can't speak up for themselves. They have the courage to feel what others fear to feel.",
        somatic: "Sienten emociones en la cabeza, la cara y los músculos: el calor aumenta, la mandíbula se aprieta, la energía en las extremidades exige movimiento. La acción física es su liberación emocional.",
        ...
        affirmation: "Tu fuego es un regalo. Tus sentimientos son válidos. Eres valiente por sentirte tan plenamente."
    },
    
    "Taurus": {
        title: "El santuario emocional",
        hook: "Esta alma necesita que el mundo se sienta seguro, predecible y cómodo antes de poder relajarse de verdad. Su mundo interior es un jardín que necesita cuidados constantes, tiempo y paciencia para florecer.",
        ...
        strength: "Estabilidad emocional y lealtad. Una vez que aman a alguien, ese amor es confiable y duradero. Crean seguridad para los demás con solo estar presentes. Su calma es un regalo para los ambientes ansiosos.",
        shadow: "El patrón de la sombra: terquedad y estancamiento emocional. Es posible que se resistan al cambio con tanta fuerza que se queden estancados en situaciones que ya no les sirven. Posesividad de las personas y las cosas. Comer reconfortante o exceso sensorial.",
        integration: "Ayúdelos a comprender que el cambio, aunque incómodo, conduce al crecimiento. Introduzca cosas nuevas lentamente, con mucho anclaje en lo familiar. Enseñe que la seguridad proviene de dentro, no sólo de circunstancias externas.",
        stress: "Bajo presión, se vuelven rígidos, resistentes y pueden cerrarse por completo. Se mantienen firmes y se niegan a ceder. La búsqueda de comodidad se intensifica: es posible que quieran comer, dormir o retirarse a espacios familiares.",
        misread: "People may see them as lazy or inflexible when they're actually processing at their natural pace, which is slower but deeper than most. Their need for routine gets labeled as rigidity.",
        relationships: "They need reliability and physical affection. Words alone don't register as love — they need touch, presence, and consistent behavior. They give the same steady devotion they need.",
        growth: "Learning to be secure even in uncertainty. Developing trust that they can handle change. Finding inner stillness that doesn't depend on external comfort.",
        power: "Cuando se adueñan plenamente de su naturaleza de santuario emocional, se convierten en una fuente de paz profunda para los demás, creando espacios seguros donde las personas pueden ser vulnerables y descansar.",
        somatic: "Sienten emociones en la garganta, el cuello y todo el cuerpo como sensaciones físicas: pesadez, calidez, necesidad de anclaje físico. El tacto es esencial para la regulación emocional.",
        ...
        affirmation: "Tu estabilidad es un regalo. Tu necesidad de comodidad es válida. Estás seguro de sentirte a tu propio ritmo."
    },
    
    "Gemini": {
        title: "El traductor emocional",
        hook: "Esta alma procesa los sentimientos hablando, pensando y dándoles sentido intelectualmente. Su mundo interior es una biblioteca ocupada: cataloga, hace referencias cruzadas y comprende emociones a través de palabras e ideas.",
        ...
        external: "Otros consideran que este niño es interesante y fácil de hablar sobre sus sentimientos. Pueden articular experiencias emocionales de manera que ayuden a otros a comprender también sus propios sentimientos. Sus palabras aportan claridad.",
        behavior: "When upset, they need to talk about it — sometimes to multiple people, sometimes for a long time. They may ask questions about their feelings: '¿Por qué me siento así?' Processing happens through dialogue and analysis.",
        strength: "La capacidad de comunicar emociones con claridad y ayudar a otros a hacer lo mismo. Pueden traducir sentimientos en palabras, haciendo visible lo invisible. Aportan comprensión y perspectiva a situaciones emocionales.",
        shadow: "El patrón de sombra: intelectualizar para evitar sentir. Pueden hablar de sentimientos sin experimentarlos realmente, utilizando las palabras como defensa contra la profundidad emocional. Inconsistencia emocional: cambios de humor sin causa aparente.",
        integration: "Ayúdelos a aprender que no todos los sentimientos se pueden explicar. A veces la respuesta es simplemente sentir, no comprender. Fundamentar el procesamiento mental en la conciencia corporal. Enseñe que permanecer más tiempo con un sentimiento revela su profundidad.",
        stress: "Bajo presión, se vuelven dispersos, ansiosos y hablan excesivamente. Su mente corre con múltiples interpretaciones emocionales. Es posible que cambien repetidamente su historia sobre cómo se sienten.",
        misread: "People may see them as emotionally shallow or inconsistent when they're actually processing in their natural way — through thinking and talking. Their curiosity about feelings gets mistaken for not having deep feelings.",
        relationships: "Necesitan estimulación mental y una buena conversación sobre los sentimientos. Quieren socios que puedan articular emociones y discutirlas de manera inteligente. El silencio emocional les resulta incómodo.",
        growth: "Aprender a permanecer con un sentimiento por más tiempo en lugar de pasar al siguiente. Desarrollar la capacidad de sentir sin analizar inmediatamente. Confiar en la intuición emocional junto con el procesamiento mental.",
        power: "Cuando se adueñan plenamente de su naturaleza de traductor emocional, se convierten en puentes entre el sentimiento y la comprensión, ayudando a otros a nombrar y procesar sus experiencias internas.",
        somatic: "Sienten emociones en su sistema nervioso y en su garganta: inquietud, necesidad de hablar, zumbidos mentales. El movimiento y la conversación son sus liberaciones emocionales.",
        ...
        affirmation: "Tu mente curiosa es un regalo. Tu necesidad de comprender es válida. Traes luz a la oscuridad emocional a través de tus palabras."
    },
    ...
    "Cancer": {
        ...
        strength: "Capacidad de amor incondicional y sintonía emocional. Saben lo que la gente necesita antes de preguntar. Crean seguridad emocional dondequiera que vayan. Su amor es profundo, protector y duradero.",
        shadow: "El patrón de sombra: manipulación emocional a través del cuidado. Dar para crear obligación. Ciclos de humor que afectan a todos los que les rodean. Usar el retraimiento emocional como castigo. Apego excesivo a la familia y al hogar.",
        integration: "Help them understand whose feelings are whose — they absorb others' emotions so easily. Teach that caring for themselves isn't selfish. Create permission to have needs separate from family needs.",
        stress: "Bajo presión, se vuelven de mal humor, pegajosos y pueden retirarse por completo. Pueden utilizar viajes de culpa o retraimiento emocional. La necesidad de hogar y seguridad se intensifica. Pueden regresar a comportamientos anteriores.",
        misread: "People may see them as overly sensitive or dramatic when they're actually responding to emotional undercurrents others aren't even aware of. Their need for security gets labeled as clinginess.",
        relationships: "Necesitan una profunda seguridad emocional y sintonía. Las relaciones a nivel de superficie los dejan vacíos. Brindan cuidados para recibir cuidados; es importante aprender que el amor existe sin condiciones.",
        growth: "Learning to separate their feelings from others'. Developing self-nurturing instead of only nurturing others. Building internal security that doesn't depend on others' emotions.",
        power: "Cuando se adueñan plenamente de su naturaleza de santuario emocional, se convierten en sanadores profundos, creando espacios donde otros pueden sentirse seguros y procesar profundamente.",
        somatic: "Sienten emociones en el pecho, el estómago y las entrañas: una cualidad de marea, oleadas de sentimiento, sensibilidad física a las atmósferas emocionales. La comida y la comodidad a menudo se entrelazan.",
        ...
        affirmation: "Tu sensibilidad es un superpoder. Tus sentimientos importan. Estás seguro de abrir tu corazón."
    },
    
    "Leo": {
        title: "El intérprete emocional",
        ...
        behavior: "Cuando están molestos, necesitan expresarlo dramáticamente Y que alguien sea testigo de ello. Ignorar su manifestación emocional empeora todo. Necesitan que se les reconozca que lo que sienten importa. Los elogios y el reconocimiento son esenciales.",
        strength: "Capacity to make others feel special, seen, and loved. They celebrate people's successes with genuine joy. Their generous heart and warm presence are gifts. They encourage others to shine too.",
        shadow: "The shadow pattern: ego-driven emotional reactions. Taking things personally that aren't about them. Needing constant validation. Dramatic wounded reactions when not recognized. Pride preventing vulnerability.",
        integration: "Help them learn that they are worthy of love even when no one is watching. Develop internal validation alongside the external. Teach that sometimes others' moments matter more than theirs.",
        stress: "Bajo presión, se sienten dramáticamente heridos, buscan atención o se sienten fríamente orgullosos. Sentirse ignorado desencadena sus inseguridades más profundas. Pueden hacer que la situación sea sobre ellos mismos.",
        misread: "People may see them as attention-seeking or over-dramatic when they're actually experiencing genuine emotional intensity that naturally expresses outward. Their need for recognition gets labeled as vanity.",
        relationships: "They need appreciation, admiration, and to feel special to the people they love. They offer the same celebration in return. Lukewarm relationships don't satisfy — they need warmth and enthusiasm.",
        growth: "Aprender a validarse a sí mismos. Dar sin esperar lealtad y devoción a cambio. Comprender que la autoestima debe venir desde dentro. A veces dejar que otros tomen el protagonismo.",
        power: "Cuando se adueñan plenamente de su naturaleza de actor emocional, se convierten en faros de calidez, inspirando a otros a expresarse plenamente, celebrar la vida y honrar sus propios sentimientos sin vergüenza.",
        somatic: "Sienten emociones en su corazón y en todo su pecho: una cualidad expansiva, una calidez que irradia hacia afuera, una necesidad física de expresarse y ser presenciado. El corazón literalmente se hincha de sentimiento.",
        parentGuidance: "Brinde atención y aprecio genuinos: LO NECESITAN. Celebre sus expresiones emocionales. Enseñe también que los momentos de tranquilidad también tienen valor. Ayúdelos a encontrar fuentes internas de validación junto con las externas.",
        affirmation: "Tu corazón es magnífico. Tus sentimientos merecen ser vistos. Eres especial incluso cuando nadie te está mirando."
    },
    
    "Virgo": {
        title: "El analista emocional",
        ...
        strength: "Capacidad para ayudar de maneras realmente útiles. Ven lo que hay que hacer y lo hacen. Aparecen con apoyo práctico, no sólo con palabras. Su atención al detalle capta lo que otros pasan por alto. Atención competente y confiable.",
        shadow: "The shadow pattern: harsh self-criticism and perfectionism. They notice every emotional flaw in themselves and may judge themselves for having needs. They believe they should handle everything alone. Critical of others' 'illogical' emotions.",
        integration: "Help them understand that needing emotional support isn't failure. Sometimes feelings don't need to be fixed — they need to be felt. Empathy before analysis. Self-compassion is a skill to develop.",
        stress: "Bajo presión, se vuelven hipercríticos, ansiosos por los detalles y pueden asumir el papel de mártires. Pueden hacer todo por sí mismos mientras se resienten silenciosamente de los demás. La ansiedad se intensifica en torno a la imperfección.",
        misread: "People may see them as emotionally cold or overly critical when they're actually trying to help in the only way that feels safe. Their carefulness gets labeled as not caring.",
        relationships: "Necesitan sentirse útiles y competentes. Ser útil es la forma en que expresan amor. Es posible que les cueste simplemente estar con alguien sin hacer algo por él. Necesitan socios que aprecien el amor práctico.",
        growth: "Learning to offer empathy before solutions. Understanding that not everyone wants to be fixed. Developing self-compassion for their own imperfections. Accepting emotional messiness — their own and others'.",
        power: "When they fully own their emotional analyst nature, they become invaluable helpers — the ones who actually show up with exactly what's needed in practical, tangible ways.",
        somatic: "Sienten emociones en sus intestinos y en su sistema nervioso: tensión, sensibilidad digestiva, un constante zumbido de evaluación de bajo nivel. Los síntomas físicos suelen expresar estrés emocional.",
        parentGuidance: "Valide su necesidad de comprender y ayudar. Enseñe también que los sentimientos son válidos incluso sin soluciones. Modele abiertamente la autocompasión. Nunca critiques sus expresiones emocionales: ya se juzgan a sí mismos con demasiada dureza.",
        affirmation: "Your attention is a gift. Your feelings don't need to be perfect. You are worthy of help too."
    },
    
    "Libra": {
        title: "El diplomático emocional",
        ...
        external: "Otros perciben a este niño como alguien emocionalmente elegante y socialmente en sintonía. Crean armonía de forma natural. Las personas se relajan en su presencia porque hacen que todo se sienta más placentero y equilibrado.",
        ...
        strength: "Capacidad para crear armonía y ver todas las perspectivas de manera justa. Ayudan a las personas a encontrar puntos en común. Aportan gracia y belleza a situaciones emocionales. Su corazón diplomático alivia el conflicto.",
        shadow: "El patrón de sombra: complacer a las personas y perder el yo en las relaciones. Pueden convertirse en quienes los demás necesitan y perder el contacto con sus sentimientos auténticos. Paz a cualquier precio, incluida su propia verdad.",
        integration: "Help them understand that authentic peace includes their truth. Some conflict leads to deeper connection. Their needs matter as much as others'. They can be kind AND honest.",
        stress: "Bajo presión, se vuelven indecisos, evitan los conflictos y dependen de los demás para recibir dirección emocional. Es posible que no sepan lo que sienten hasta que alguien más lo defina. Pueden surgir patrones pasivo-agresivos.",
        misread: "People may see them as superficial or fake when they're genuinely trying to create harmony. Their desire to please gets labeled as having no personality. Their peace-keeping gets called avoidance.",
        relationships: "They need partnership, fairness, and beautiful experiences. They feel incomplete without connection. Balanced give-and-take and mutual respect are essential. They're deeply romantic.",
        ...
        power: "When they fully own their emotional diplomat nature, they become true peacemakers — bridging divides and creating genuine harmony that includes everyone's truth.",
    ...
    "Scorpio": {
        title: "El alquimista emocional",
        hook: "Esta alma siente todo con la máxima intensidad: su mundo interior es un lugar de profunda profundidad, sentimientos poderosos y experiencias emocionales transformadoras al que la mayoría de las personas nunca acceden.",
        ...
        external: "Otros experimentan a este niño como emocionalmente intenso y magnéticamente poderoso. Las personas sienten su profundidad y pueden sentirse atraídas o intimidadas por su presencia penetrante. Parecen ver a través de la simulación.",
        ...
        strength: "Capacidad de transformación profunda y profundidad emocional. Pueden afrontar la oscuridad sin inmutarse. Entienden que la curación ocurre en lo más profundo. Su amor, una vez dado, es total y transformador.",
        shadow: "The shadow pattern: destructive emotional intensity. When hurt, they may seek revenge or use their intimate knowledge of people's vulnerabilities against them. Their power to heal matches their power to wound. Jealousy and possessiveness.",
        integration: "Help them learn that transformation doesn't require destruction. Teach them to release pain rather than store it. Trust can be rebuilt. Not everyone who hurts them intended betrayal.",
        stress: "Under pressure, they become controlling, jealous, or emotionally manipulative. They may test people's loyalty by creating drama. Paranoid tendencies may emerge. They may use silence as punishment.",
        ...
        growth: "Aprender a confiar sin probar. Amar sin controlar. Liberar el resentimiento antes de que los envenene. Comprender que la vulnerabilidad es el mayor poder de todos.",
        power: "Cuando poseen plenamente su naturaleza alquimista emocional, se convierten en transformadores, ayudando a otros a enfrentar y transmutar sus heridas más profundas en oro.",
        somatic: "Sienten emociones en la parte inferior del abdomen, el plexo solar y las áreas reproductivas: una intensidad agitada, un poder que surge desde lo más profundo de su interior. La energía sexual y emocional se entrelazan incluso en la niñez como fuerza vital.",
        ...
        affirmation: "Tu intensidad es sagrada. Tus profundidades son tesoros. Tu poder está destinado a la transformación, no a la destrucción."
    },
    
    "Sagittarius": {
        title: "El explorador emocional",
        ...
        external: "Otros consideran que este niño es emocionalmente edificante e inspirador. Su optimismo es contagioso. Ayudan a las personas a ver posibilidades y encontrar significado en experiencias difíciles. Su entusiasmo ilumina el camino.",
        behavior: "Cuando surgen sentimientos difíciles, buscan expansión: quieren ir a algún lugar, hacer algo, aprender algo nuevo. Procesan emociones ganando altitud y perspectiva. Sentarse con sentimientos difíciles resulta asfixiante.",
        strength: "Capacity to find meaning and hope in any situation. They help others see possibilities. They inspire faith in life's benevolence. Their optimism is genuine, not denial. Adventurous emotional spirit.",
        shadow: "El patrón de sombra: evitar la profundidad emocional mediante el movimiento constante. Cuando los sentimientos se vuelven incómodos, cambian de tema, hacen una broma o se van. Usar el optimismo para evitar el dolor genuino.",
        integration: "Help them learn that some feelings don't need meaning — they just need to be felt. Sitting with discomfort sometimes, rather than immediately reframing, builds emotional depth. Stay present.",
        stress: "Bajo presión, se vuelven dispersos, sermoneadores o fóbicos al compromiso. Pueden sabotear las relaciones cuando empiezan a sentirse demasiado serios o limitantes. Es posible que sermoneen en lugar de escuchar.",
        misread: "People may see them as emotionally avoidant or superficial when they're actually processing in their natural way — through expansion and meaning-making. Their freedom needs get labeled as lack of commitment.",
        relationships: "Necesitan libertad, aventura y espacio para crecer. El apego emocional les hace querer correr. Necesitan socios que sean lo suficientemente seguros como para darles espacio y lo suficientemente evolucionados para una exploración significativa.",
        growth: "Learning that true freedom exists within commitment to people who honor their nature. Depth doesn't require abandoning exploration. Sometimes staying is the adventure.",
        power: "Cuando se apropian plenamente de su naturaleza de explorador emocional, se convierten en guías y ayudan a otros a encontrar significado, esperanza y una perspectiva expansiva en sus momentos más oscuros.",
        somatic: "Sienten emociones en las caderas, los muslos y como una sensación de expansión o restricción: inquietud cuando están estancados, alivio cuando se mueven. La libertad física apoya la libertad emocional.",
        ...
        affirmation: "Tu espíritu aventurero es un regalo. Tu optimismo cura. Eres libre, incluso en la quietud."
    },
    
    "Capricorn": {
        title: "El ejecutivo emocional",
        ...
        strength: "Reliability and capacity to show love through tangible support. When crisis hits, they don't fall apart — they show up and handle what needs handling. Their steady strength provides security for others.",
        shadow: "The shadow pattern: emotional coldness and isolation. They may build walls so high no one can reach them. They judge others for being 'too emotional' while denying their own needs. Workaholism as emotional avoidance.",
        integration: "Help them understand that vulnerability is strength, not weakness. Needing others is human, not failure. Feelings matter even when they don't serve obvious purpose. Play and rest are productive.",
    ...
    "Aquarius": {
        ...
        strength: "Capacity to love without possessiveness. They support people's individuality and freedom. They don't try to change people. Their love is liberating rather than constraining. They help others see beyond limits.",
        shadow: "The shadow pattern: emotional unavailability. They may use intellectualization to avoid genuine vulnerability. They may be present in body but emotionally detached. Rejecting conventional emotion as 'too basic.'",
        integration: "Help them understand that intimacy doesn't mean losing themselves. Some traditional emotional expressions aren't conformity — they're genuine human connection. Feeling deeply doesn't compromise uniqueness.",
        stress: "Bajo presión, se vuelven distantes, contrarios o emocionalmente ausentes. Pueden retirarse a ideas abstractas mientras evitan al ser humano que tienen delante. Pueden rebelarse contra las expectativas emocionales.",
        misread: "People may see them as cold, weird, or uncaring when they're actually loving in their unique way — one that doesn't match conventional expectations. Their independence gets labeled as not caring.",
        relationships: "Necesitan libertad y amor basado en la amistad. La intimidad emocional tradicional puede resultar asfixiante. Quieren asociaciones basadas en el respeto mutuo, ideales compartidos y espacio para el crecimiento individual.",
        growth: "Learning that they can be free within connection. Some traditional expressions of love — presence, affection, emotional availability — aren't conformity but genuine care. Letting people close doesn't mean losing freedom.",
        power: "Cuando asumen plenamente su naturaleza innovadora emocional, se convierten en liberadores, liberando a otros de convenciones emocionales que limitan la expresión auténtica y abriendo nuevas formas de amar.",
        somatic: "Sienten las emociones en su sistema nervioso como una carga eléctrica: intuiciones repentinas, zumbidos de energía, conexión con algo más grande que los sentimientos personales. Sus emociones a menudo se conectan con temas colectivos.",
        ...
        affirmation: "Tu singularidad es sagrada. Tu forma de sentir es válida. Eres amado exactamente como eres."
    },
    
    "Pisces": {
        title: "El místico emocional",
        ...
        strength: "Compasión ilimitada y profundidad espiritual. Aman incondicionalmente y ven lo divino en todos. Ayudan a otros a acceder a sus propias profundidades emocionales y espirituales. Su presencia cura sin palabras.",
        shadow: "El patrón de sombra: conciencia de víctima y disolución de límites. Es posible que se sacrifiquen por la incapacidad de decir no y no por una elección genuina. Pueden utilizar fantasías, sustancias o dormir para escapar de la realidad.",
        integration: "Ayúdelos a permanecer presentes con dificultad en lugar de escapar. Enseñe límites fuertes para proteger su don, no limitar su amor. Pueden ser compasivos Y protegidos. Sus necesidades también importan.",
        stress: "Bajo presión, se vuelven escapistas y se disuelven en la fantasía, el sueño excesivo o la imaginación. La realidad parece demasiado dura. Es posible que desaparezcan en lugar de afrontar la situación. Pueden convertirse en mártires.",
        misread: "People may see them as weak, spacey, or unstable when they're actually carrying emotional weight that most people can't even perceive. Their sensitivity gets labeled as impracticality.",
        relationships: "Necesitan conexión del alma y comprensión espiritual. Las relaciones superficiales los dejan aislados a pesar de estar rodeados de gente. Quieren amor incondicional y experiencias trascendentes.",
        growth: "Learning that they can be compassionate with boundaries. Saving themselves from drowning in others' pain actually helps them help more. Discernment protects their gift. They can be loving AND grounded.",
        power: "Cuando se adueñan plenamente de su naturaleza mística emocional, se convierten en sanadores profundos, accediendo a profundidades de compasión y percepción espiritual que genuinamente transforman a los demás a nivel del alma.",
        somatic: "They feel emotions as boundaryless flow — a dissolution of where they end and others begin, sensitivity to unseen energies, physical porousness. They may feel others' physical symptoms.",
        parentGuidance: "Protégelos del agobio emocional respetando su sensibilidad. Enséñeles qué sentimientos son los suyos. Bríndeles salidas creativas. Nunca avergüences su sensibilidad. Ayúdelos a mantenerse firmes en su cuerpo. Limite la exposición a medios hostiles o entornos estresados.",
        affirmation: "Tu sensibilidad es un don sagrado. Tu compasión sana. Puedes ser amoroso Y protegido."
    }
};
...
var DEEP_RISING_READINGS = {
    "Aries": {
        ...
        lifeApproach: "They approach life as a series of challenges to be conquered, adventures to be undertaken, and territories to be claimed. New situations are met with courage and enthusiasm rather than caution or analysis. They naturally take initiative, often stepping forward before others have even assessed the situation. This isn't recklessness — it's a fundamental trust in their ability to handle whatever comes. Throughout life, this child will be the one who goes first, tests the waters, and opens doors for others to follow.",
        howOthersSee: "Others see a confident, energetic, and sometimes impatient soul who isn't afraid to go first. They may seem brave to the point of recklessness, competitive to the point of aggression, or direct to the point of bluntness — but this is simply their natural way of meeting life head-on. People are drawn to their vitality and courage, even when they're occasionally overwhelmed by their intensity. As this child grows, they'll learn that their directness is a gift in a world of hedging and hesitation.",
        physicalExpression: "Often marked by athletic ability, quick movements, and dynamic energy that seems to charge the air around them. They may have prominent facial features, especially around the forehead, brows, and eyes — features that suggest alertness and readiness. They radiate heat and vitality. Even in stillness, there's a coiled quality, as if they could spring into action at any moment. Their body is their vehicle for experiencing life directly.",
        lifePath: "Their path involves learning to lead with wisdom as well as courage, to temper speed with timing, and to channel their initiating energy toward goals worthy of their fire. They're here to pioneer new territory — whether physical, intellectual, or creative — and to show others that fear is meant to be walked through, not avoided. The Aries Rising life is one of constant new beginnings, and their gift is making starting look easy.",
        gift: "El don del coraje y la iniciación. Demuestran que la acción es el antídoto contra el miedo, que el liderazgo comienza simplemente con dar un paso adelante y que el mundo necesita personas dispuestas a ir primero. Su sola presencia da permiso a los demás para ser audaces.",
        challenge: "Learning patience and timing, considering others before acting, understanding that some battles aren't worth fighting, and recognizing that their way isn't the only way. The most evolved Aries Rising learns that true warriors know when NOT to fight.",
        ...
        synthesis: "With Aries Rising, this child's Sun and Moon energies are filtered through a lens of action, initiative, and courage. Whatever their deeper nature, the world will first experience them as bold and direct. Their life lessons will often arrive through situations requiring them to act decisively, lead others, or pioneer new paths."
    },
    
    "Taurus": {
        title: "Llega la presencia pacífica",
        firstImpression: "This child enters every room with calm, grounded energy that seems to settle the space around them. Their presence is stabilizing — others unconsciously relax in their company. There's a soothing, earthy quality from the first breath, as if they're deeply rooted in the physical world.",
        lifeApproach: "They approach life at their own steady pace, refusing to be rushed by external pressures or others' timelines. New situations are met with careful assessment before engagement — they need to sense that something is safe and worthwhile before committing. They value comfort, beauty, and quality in all things, naturally gravitating toward what's pleasant and enduring. This isn't laziness; it's an innate wisdom about sustainable pacing. They understand instinctively that slow and steady wins races that sprinters burn out on.",
        howOthersSee: "Otros ven un alma confiable, paciente, con excelente gusto y una calma inquebrantable. Pueden parecer lentos o testarudos para aquellos que se mueven más rápido, pero en realidad esto es un compromiso cuidadoso y deliberado con la vida. Las personas llegan a depender de su estabilidad y se sienten tranquilizadas por su coherencia. A medida que este niño crezca, otros lo buscarán como una presencia tranquilizadora en medio del caos.",
        physicalExpression: "Often marked by physical beauty or attractiveness, strong constitution, and a sensual quality that appreciates textures, tastes, and physical pleasures. They may have prominent necks and throats (Taurus rules this area), and often have beautiful speaking or singing voices. They radiate calm and solidity, as if gravity affects them more than others. There's a tangible, grounded quality to their physical presence.",
        lifePath: "Their path involves learning to create lasting value while remaining flexible enough to adapt when necessary. They're here to build beautiful, enduring things — whether homes, relationships, art, or resources — and to teach others the wisdom of patience and persistence. They ground others in stability while learning that true security ultimately comes from within.",
        gift: "The gift of presence and patience. They demonstrate that slowing down reveals life's true beauty, that quality matters more than speed, and that patience creates lasting results. Their calm is a sanctuary for stressed souls.",
        ...
        parentGuidance: "Mantenga rutinas consistentes: este niño se nutre de la previsibilidad. Regálales cosas bonitas y experiencias sensoriales. Nunca apresure su tiempo de procesamiento; se mueven deliberadamente por una buena razón. Enseñe flexibilidad suavemente a través de experiencias positivas con el cambio. Permítales poseer y cuidar posesiones significativas. Introduzca nuevas experiencias con mucha conexión con lo familiar.",
        synthesis: "With Taurus Rising, this child's Sun and Moon energies are filtered through a lens of stability, sensuality, and patience. Whatever their deeper nature, the world will first experience them as calm and grounded. Their life lessons will often arrive through situations involving security, resources, and learning to balance steadiness with necessary change."
    },
    
    "Gemini": {
        title: "Llega la mente curiosa",
        firstImpression: "This child enters every room with bright, curious energy that seems to take in everything at once. Their eyes are active and alert, scanning for information and connection. There's an unmistakable mental quickness and desire to communicate from the first breath — they seem to be thinking and processing constantly.",
        lifeApproach: "Enfrentan la vida como una aventura de aprendizaje sin fin donde todo y todos tienen algo que enseñar. Las situaciones nuevas se enfrentan con preguntas, exploración y evaluación rápida de elementos interesantes. Quieren comprender, conectarse y comunicar todo lo que encuentran. Sus mentes trabajan rápidamente, haciendo conexiones que otros pasan por alto, saltando de un tema a otro siguiendo patrones que tienen perfecto sentido para ellos. La vida es un rompecabezas gigante que hay que resolver, una historia que hay que entender, una conversación esperando a suceder.",
        howOthersSee: "Others see an intelligent, versatile soul who's easy to talk to and never boring. They may seem scattered or superficial to those who value depth over breadth, but this is actually rapid processing of multiple interests simultaneously. Their curiosity is charming, their wit is quick, and their ability to find common ground with anyone is a social superpower. As this child grows, they'll become the connector who links people and ideas.",
        physicalExpression: "A menudo se caracterizan por manos expresivas que gesticulan mientras hablan, movimientos rápidos que reflejan sus mentes en rápido movimiento y una apariencia juvenil que tiende a envejecer lentamente. Pueden tener ojos brillantes y alerta y expresiones faciales animadas que cambian rápidamente con sus pensamientos. Irradian energía mental y parecen más vivos cuando conversan o aprenden algo nuevo.",
        lifePath: "Their path involves learning to go deep as well as wide, to commit to ideas long enough to master them, and to use their gift for communication in service of meaningful messages. They're here to connect ideas and people, communicate important information, keep minds open, and remind the world that curiosity is a virtue.",
        gift: "El don de la comunicación y la conexión. Demuestran que el aprendizaje nunca termina, que la versatilidad es la fuerza y ​​que establecer conexiones (entre ideas, entre personas) es un trabajo esencial. Sus mentes salvan divisiones.",
        challenge: "Aprender profundidad y concentración, comprometerse a terminar lo que empiezan, comprender que la presencia a veces significa estar quieto y en silencio, y reconocer que no es necesario expresar todos los pensamientos.",
        ...
        synthesis: "With Gemini Rising, this child's Sun and Moon energies are filtered through a lens of curiosity, communication, and mental agility. Whatever their deeper nature, the world will first experience them as quick-minded and verbally expressive. Their life lessons will often arrive through situations involving communication, learning, and developing focus amid variety."
    },
    
    "Cancer": {
        title: "Llega el alma nutricia",
        firstImpression: "This child enters every room with sensitive, receptive energy that seems to read the emotional atmosphere immediately. They're like walking antennae for feelings — theirs and everyone else's. There's a caring, protective quality from the first breath, as if they arrived already knowing how to nurture.",
        lifeApproach: "They approach life through the lens of emotional safety and belonging, instinctively assessing who can be trusted and where they'll be cared for. New situations are met with caution until safety is established, then with full emotional engagement once they feel secure. They lead with their hearts, making decisions based on how things feel rather than how they look on paper. Home and family — however they define these — will always be central concerns. They naturally create belonging wherever they go.",
        howOthersSee: "Others see a caring, intuitive soul who creates comfort and emotional safety wherever they go. They may seem shy, moody, or overly cautious to those who don't understand their sensitivity, but this is actually deep emotional awareness that takes time to trust. Their nurturing is genuine and freely given to those in their inner circle. As this child grows, people will seek them out when they need to feel cared for.",
        physicalExpression: "Often marked by round or moonlike faces, expressive eyes that seem to reflect emotions like pools of water, and nurturing gestures that comfort before words are spoken. They may seem to physically soften the spaces they're in, as if their presence creates a warmer atmosphere. They radiate emotional warmth that others can literally feel.",
        lifePath: "Their path involves learning to nurture themselves as well as others, to create emotional safety without becoming a caretaker who loses themselves, and to honor the past while moving forward. They're here to teach others about the importance of home, belonging, and emotional connection — and to learn that their needs matter as much as everyone else's.",
        gift: "El don de pertenencia y la inteligencia emocional. Demuestran que todo el mundo necesita seguridad emocional, que crear un hogar es un acto sagrado y que cuidar de los demás es un trabajo significativo. Su amor crea santuario.",
        challenge: "Aprender a dejar ir a las personas que necesitan irse, no identificarse demasiado con roles de cuidado, establecer límites sin culpa y comprender que sus necesidades emocionales importan tanto como las de aquellos a quienes cuidan.",
        ...
        synthesis: "With Cancer Rising, this child's Sun and Moon energies are filtered through a lens of emotion, nurturing, and intuitive sensitivity. Whatever their deeper nature, the world will first experience them as caring and emotionally attuned. Their life lessons will often arrive through situations involving family, home, and learning to balance caring for others with caring for themselves."
    },
    
    "Leo": {
        title: "Llega el corazón radiante",
        firstImpression: "This child enters every room with warm, confident energy that naturally draws attention without trying. Their presence is magnetic — people look up when they walk in. There's an unmistakable radiance from the first breath, as if they arrived with their own personal spotlight.",
        lifeApproach: "They approach life as a creative adventure meant to be enjoyed fully, performed beautifully, and celebrated loudly. New situations are met with enthusiasm and self-assurance — they expect to be welcomed and usually are. They naturally take center stage, not from arrogance but from genuine comfort with visibility. Life is theater, and they're here to play their part with passion and joy. They bring warmth and enthusiasm to everything they do.",
        howOthersSee: "Others see a warm, generous soul who lights up spaces and makes people feel special. They may seem dramatic, attention-seeking, or overly proud to those who don't appreciate their genuine warmth, but this is actually joyful expression from a heart that wants everyone to shine. Their enthusiasm is contagious, and their generosity is real. As this child grows, they'll become someone who makes others feel seen and celebrated.",
        physicalExpression: "A menudo se caracteriza por una postura orgullosa, una fuerte presencia física y un cabello parecido a una melena que tiende a ser notable. Es posible que tengan amplias sonrisas que iluminen todo su rostro y gestos expresivos que llamen la atención de forma natural. Irradian calidez solar y confianza que otros pueden sentir incluso antes de la interacción. Su presencia física parece ocupar más espacio que su cuerpo real.",
        lifePath: "Their path involves learning that their light doesn't dim others' — in fact, their true purpose is to help everyone shine. They're here to inspire through joyful expression, celebrate life as it deserves, and encourage everyone to express their unique gifts without shame. They must also learn that their worth exists independent of applause.",
        gift: "El don de la expresión y la celebración. Demuestran que la vida debe celebrarse, que la alegría es un acto revolucionario y que todos merecen ser vistos y apreciados. Su presencia da permiso a los demás para brillar.",
        challenge: "Learning that attention isn't always about them, developing genuine humility, accepting that their worth isn't dependent on applause, and recognizing that supporting others' spotlight can be as fulfilling as their own.",
        ...
        synthesis: "With Leo Rising, this child's Sun and Moon energies are filtered through a lens of warmth, creativity, and radiant self-expression. Whatever their deeper nature, the world will first experience them as confident and heart-centered. Their life lessons will often arrive through situations involving creativity, recognition, and learning that their worth is inherent, not earned."
    },
    
    "Virgo": {
        title: "Llega el ayudante sagrado",
        firstImpression: "This child enters every room with observant, discerning energy that notices details others miss. Their eyes seem to analyze and assess, taking in information systematically. There's a careful, thoughtful quality from the first breath — they seem to be already thinking about how things could work better.",
        lifeApproach: "They approach life through the lens of improvement and service, naturally seeing what could be better and wanting to help make it so. New situations are met with assessment and practical problem-solving — they quickly identify what needs attention. They want to be useful, to contribute meaningfully, and to do things well. This isn't perfectionism for its own sake; it's a genuine desire to be of service and to honor their work with excellence. They find meaning in being helpful.",
        howOthersSee: "Otros ven un alma servicial y modesta que pone orden en el caos y resuelve problemas que nadie más notó que existían. Pueden parecer críticos, quisquillosos o demasiado centrados en los detalles para aquellos que prefieren el pensamiento global, pero en realidad se trata de altos estándares aplicados para ayudar genuinamente. Su atención al detalle es un regalo que mejora todo lo que tocan. A medida que este niño crezca, la gente lo buscará cuando necesite que algo se haga bien.",
        physicalExpression: "Often marked by refined features, neat presentation, and capable hands that seem designed for precise work. They may seem physically self-contained and organized, with an economy of movement that wastes nothing. They radiate competence and carefulness. Even young, there's often a quality of being together that others notice.",
        lifePath: "Their path involves learning that imperfection is part of the human journey, that their worth isn't measured by their output, and that rest and joy are also productive. They're here to serve without martyrdom, improve without harsh criticism, find the sacred in ordinary tasks, and teach that attention itself is a form of love.",
        gift: "El don del discernimiento y el servicio devoto. Demuestran que la atención y el cuidado lo mejoran todo, que los detalles importan y que servir a los demás es un trabajo noble. Su precisión es una expresión de amor.",
        challenge: "Aprender la autocompasión y aplicar sus estándares amables a sí mismos, aceptar la imperfección sin vergüenza y comprender que descansar, jugar y no hacer nada también son productivos y valiosos.",
        parentGuidance: "Elogie el esfuerzo y la ayuda, no sólo los resultados perfectos. Deles responsabilidades significativas que les permitan contribuir. Nunca te burles de su atención al detalle. Enséñeles que los errores son la forma en que los humanos aprenden, no la evidencia de un fracaso. Modele la autocompasión. Muéstreles que son amados por lo que son, no por lo que hacen o producen.",
        synthesis: "With Virgo Rising, this child's Sun and Moon energies are filtered through a lens of service, discernment, and practical improvement. Whatever their deeper nature, the world will first experience them as helpful and detail-oriented. Their life lessons will often arrive through situations involving service, health, and learning to balance high standards with self-compassion."
    },
    
    "Libra": {
        title: "Llega el armonizador",
        firstImpression: "This child enters every room with graceful, balanced energy that seems to smooth rough edges in the environment. Their presence is pleasing — others feel more comfortable and at ease. There's a pleasant, socially aware quality from the first breath, as if they arrived understanding that life is about relationship.",
        lifeApproach: "Afrontan la vida a través de la lente de la relación y la belleza, instintivamente conscientes de cómo sus acciones afectan a los demás y a la armonía del conjunto. Las nuevas situaciones se enfrentan con conciencia de la dinámica social y de cómo crear equilibrio. Naturalmente buscan justicia, belleza y paz en todos sus tratos. Hacer que todos se sientan cómodos es casi un reflejo. Creen genuinamente que en la mayoría de las situaciones se pueden encontrar soluciones que funcionen para todos.",
        howOthersSee: "Others see a charming, diplomatic soul who makes everyone feel at ease and seems to create harmony wherever they go. They may seem indecisive or people-pleasing to those who value quick, independent action, but this is actually deep consideration of all perspectives. Their grace and social awareness are genuine gifts. As this child grows, they'll become the natural mediator and peacemaker in any group.",
        physicalExpression: "A menudo se caracteriza por rasgos simétricos y agradables que parecen naturalmente equilibrados y atractivos. Tienen expresiones agradables y una conciencia estética que se nota en su forma de presentarse. Puede parecer que se visten bien de forma natural o crean armonía visual a su alrededor. Irradian equilibrio y agrado que atrae a los demás hacia ellos.",
        lifePath: "Their path involves learning that true balance includes their own needs, that conflict isn't always bad, and that taking a clear stand is sometimes the most harmonious choice. They're here to create beauty, champion fairness, facilitate harmony, and show that multiple truths can coexist — while learning that their truth matters too.",
        gift: "El regalo de la paz y la belleza. Demuestran que la armonía es posible, que la justicia importa, que la belleza mejora la vida y que considerar a los demás es sabiduría. Su presencia crea equilibrio.",
        challenge: "Learning that conflict isn't always bad and can lead to deeper harmony, developing strong personal identity apart from relationships, making decisions even when not everyone agrees, and understanding that their needs matter as much as others'.",
        ...
        synthesis: "With Libra Rising, this child's Sun and Moon energies are filtered through a lens of relationship, beauty, and harmony. Whatever their deeper nature, the world will first experience them as graceful and socially aware. Their life lessons will often arrive through situations involving partnerships and learning to balance others' needs with their own."
    },
    
    "Scorpio": {
        title: "Llega el alma profunda",
        firstImpression: "This child enters every room with intense, penetrating energy that seems to see through pretense immediately. Their gaze is knowing, their presence is powerful. There's a magnetic quality from the first breath — people sense this is someone who operates at depths most never explore.",
        lifeApproach: "They approach life through the lens of truth and transformation, instinctively seeking what's real beneath surfaces. New situations are met with careful assessment of who and what can be trusted — they don't give trust easily, but once given, it's complete. They naturally seek depth in all things and have little patience for superficiality. Life for them is about power, transformation, and emotional truth. They're comfortable with the parts of existence most people avoid.",
        howOthersSee: "Others see an intense, perceptive soul who doesn't do superficial and can't be fooled. They may seem intimidating, secretive, or too intense to those who prefer lightness, but this is actually deep discernment about who's safe to trust. Their intensity is a gift for those ready to be seen truly. As this child grows, people will come to them with their secrets, knowing they'll be kept.",
        physicalExpression: "Often marked by penetrating eyes that seem to look through rather than at, powerful physical presence that commands respect, and a magnetic quality that draws others in despite — or because of — their intensity. They seem to hold secrets and depths. Even in childhood, there's a knowing quality that can be unsettling to those who prefer surfaces.",
        lifePath: "Their path involves learning to transform rather than destroy, to use their power for healing rather than control, and to trust that vulnerability is actually their greatest strength. They're here to face life's depths, guide others through their own dark nights, emerge renewed from every ending, and show that darkness doesn't last.",
...
var DEEP_SUN_READINGS = {
    "Aries": {
        ...
        creativeExpression: "Crean mediante acciones audaces e impulsivas. Su arte es el arte de los comienzos. Cada proyecto que inician lleva la carga eléctrica de la posibilidad. Puede que no siempre terminen, pero su capacidad para encenderse es incomparable.",
    ...
    "Sagittarius": {
        ...
        lifeLesson: "Aprender que algunas verdades están más allá de las palabras. Descubrir que la presencia a veces es mejor que la persecución. Comprender ese compromiso puede ser su propia aventura.",
...
var COSMIC_WRAPUP_TEMPLATES = {
    introduction: `Esta alma llegó el ${'{DATE}'} a ${'{TIME}'} con un modelo cósmico que nunca antes existió y nunca volverá a existir. Cada posición planetaria, cada aspecto, cada cúspide de casa alineada en este momento único para crear ${'{NAME}'}.
...
En el centro de este diseño cósmico hay un ${'{SUN_SIGN}'} Sol — ${'{SUN_BRIEF}'}. Esta es la luz que ${'{NAME}'} está aquí para brillar, el viaje del héroe que están aquí para recorrer.

Pero el Sol es sólo la superficie visible. Debajo fluye una ${'{MOON_SIGN}'} Luna — ${'{MOON_BRIEF}'}. Esta es su base emocional, la forma en que necesitan ser amados, el santuario interior al que regresarán durante toda la vida.
...
Life Path ${'{LIFE_PATH}'} atraviesa todo: ${'{LIFE_PATH_BRIEF}'}. Ésta es la corriente numerológica que los llevará hacia su destino.`,
...
Es posible que tengan dificultades cuando ${'{STRUGGLE_CONDITIONS}'}.
...
• Brilla como tu ${'{SUN_SIGN}'} Sol
• Siéntete como tu ${'{MOON_SIGN}'} Luna
...
Pueden parecer inseguros o poco claros acerca de quiénes son; esto es parte de su naturaleza, no un problema que deba solucionar. Su identidad cristaliza probando cosas, no planificando.`,
...
A lo largo de la vida, se encontrarán en posiciones de compartir conocimientos, formal o informalmente. Pueden ser mentores, enseñar, escribir o simplemente ser el amigo al que todos acuden en busca de sabiduría.`,
...
Es posible que tengan dificultades con el apego, no porque no amen sino porque sienten los finales con mayor intensidad. Aprender a mantener las cosas sin apretar y al mismo tiempo amar profundamente es su trabajo.`,
